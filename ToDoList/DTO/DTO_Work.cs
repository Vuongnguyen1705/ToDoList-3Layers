...
namespace DTO
{
    class DTO_Work
    {
        ...
        public DTO_Work(string workID, string workTitle, DateTime workStartDate, DateTime workEndDate, string workState, string workRange, string workCoWorker, string workAttachment, string workUserID)
        {
            this.WorkID = workID;
