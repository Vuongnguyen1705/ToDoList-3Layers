...
namespace DTO
{
    public class User
    {
        ...
        public User(int userID, string userFullName, string userPhoneNumber, string userEmail, string userpassWord, string userAddress, DateTime userBirthDate, string userGender, int userRole)
        {
            this.userID = userID;
